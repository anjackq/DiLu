...
def parse_args():
    ...
    parser.add_argument("--model-family", default="auto", choices=["auto", "llama3", "qwen", "mistral", "deepseek", "phi"], help="Model-family presets.")
    ...
    parser.add_argument("--max-seq-length", type=int, default=2048, help="Override max sequence length (0 = family default).")
